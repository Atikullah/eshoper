...
@section('content')
    ...
    <div class="feedback-w3layouts" style="background-color: black;height:650px;width: 100%;">
        ...
        <div class="feedback-w3layouts" style="background-color: teal;">
            <h1 style="margin-top: 20px;color: lime;"> Add Categori Form </h1>
            <form action="{{route('Add_categori.submit')}}" method="post">
                {{csrf_field()}}

                <div class="form-group">
                    <label>Enter categori name</label>
                    <input type="text" name="name" placeholder="Enter your name" class="form-control" style="color: white;font-style: italic;font-size:large;">
                ...
                <div class="form-group"><br><br>
                    <button class="btn btn-primary btn-lg" type="submit">Add Categori</button>
